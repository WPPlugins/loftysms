    ...
    <div class="col-md-8 col-md-offset-2">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <span class="pull-right">Total Balance: <?php echo ($message->currency.' '.$message->user->balance+$message->user->overdraft+$message->user->bonus+$message->user->referral_bonus)?></span>
            </div>
